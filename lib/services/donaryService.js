...
async function processChargeWebhook(webhookData, prisma, campaignId) {
    ...
    // Find the donor in our campaign by matching person.clientSystemId
    ...
    if (!donorRecord) {
        console.error('[Donary Webhook] Donor not found in campaign:', { clientSystemId, campaignId, donorID });
        return null;
    }
...
async function processScheduleWebhook(webhookData, prisma, campaignId) {
    ...
    // Find the donor record by matching person.clientSystemId
    ...
    if (!donor) {
        console.error('[Donary Webhook] Donor not found for clientSystemId:', clientSystemId, 'in campaign:', campaignId);
        return null;
    }
...
async function processPledgeWebhook(webhookData, prisma, campaignId) {
    ...
    const donorNumber = donorInfo?.donorNumber;
    if (!donorNumber) {
        console.error('[Donary Webhook] Missing donorNumber in pledge webhook');
        return null;
    }
