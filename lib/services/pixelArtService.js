...
export async function sendDonationToPixelArt(donationId) {
    try {
        ...
        // הערך שיישלח כ-monthly_amount (לתשלום בודד). בקמפיין רגיל = סכום כספי, בקמפיין יחידות = כמות יחידות.
        const perPaymentValue = isUnitMode ? (monthly / unitPrice) : monthly;
        ...
        const payload = {
            ...
            donation: {
                ...
                monthly_amount: Math.round(perPaymentValue * 100),
