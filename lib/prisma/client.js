...
// Prisma מחזיר שדות BigInt (כמו externalDonationId) כ-BigInt של JS,
// ו-JSON.stringify (שבו משתמש NextResponse.json) זורק שגיאה על BigInt.
// shim זה גורם ל-BigInt להפוך למחרוזת בעת סריאליזציה במקום לקרוס.
...
function sanitizeData(data) {
  ...
  // Date ועצמים מיוחדים אחרים - לא לגעת בהם
